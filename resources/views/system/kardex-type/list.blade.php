                ...
                <div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a class="btn sbold green modal-view" data-url="{{ route('kardex-type.create') }}" data-toggle="modal"> Agregar registro
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a class="modal-view" data-url="{{ route('kardex-type.edit', $row_id) }}" data-toggle="modal">Editar</a></li>
