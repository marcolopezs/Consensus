        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="portlet light portlet-datatable " id="form_wizard_1">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="{{ route('state.create') }}" data-target="#ajax" data-toggle="modal"> Agregar registro
                    ...
                    <div class="actions">
                        ...
                        <div class="btn-group btn-group-devided">
                            <div class="btn-group">
                                <a class="btn green-haze btn-outline btn-circle" href="{{ route('state.excel', Request::all()) }}">
                ...
                <div class="portlet-body">
                    ...
                    {!! Form::model(Request::all(), ['route' => 'state.index', 'method' => 'GET']) !!}

                    <table class="table table-striped table-bordered table-hover order-column">

                        @include('system.state.partials.search')
                        ...
                        @foreach($rows as $item)
                            ...
                            <tr class="odd gradeX" data-id="{{ $row_id }}" data-title="{{ $row_titulo }}">
                                ...
                                <td class="text-center">
                                    @can('update')
                                        <a id="estado-{{ $row_id }}" href="#" class="btn-estado" data-id="{{ $row_id }}" data-title="{{ $row_titulo }}" data-url="{{ route('state.estado', $row_id) }}">
