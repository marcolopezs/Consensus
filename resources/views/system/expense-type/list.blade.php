        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="portlet light portlet-datatable " id="form_wizard_1">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="{{ route('expense-type.create') }}" data-target="#ajax" data-toggle="modal"> Agregar registro
                    ...
                    <div class="actions">
                        ...
                        <div class="btn-group btn-group-devided">
                            <div class="btn-group">
                                <a class="btn green-haze btn-outline btn-circle" href="{{ route('expense-type.excel', Request::all()) }}">
                ...
                <div class="portlet-body">
                    ...
                    {!! Form::model(Request::all(), ['route' => 'expense-type.index', 'method' => 'GET']) !!}

                    <table class="table table-striped table-bordered table-hover order-column">

                        @include('system.expense-type.partials.search')
                        ...
                        @foreach($rows as $item)
                            ...
                            <tr class="odd gradeX" data-id="{{ $row_id }}" data-title="{{ $row_titulo }}">
                                ...
                                <td class="text-center">
                                    @can('update')
                                        <a id="estado-{{ $row_id }}" href="#" class="btn-estado" data-id="{{ $row_id }}" data-title="{{ $row_titulo }}" data-url="{{ route('expense-type.estado', $row_id) }}">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a class="menu-ver" href="{{ route('expense-type.show', $row_id) }}" data-target="#ajax" data-toggle="modal">Ver</a></li>
                                            @can('update')
                                            <li><a class="menu-editar" href="{{ route('expense-type.edit', $row_id) }}" data-target="#ajax" data-toggle="modal">Editar</a></li>
                                            @endcan
                                        </ul>
                                    </div>
                                </td>
