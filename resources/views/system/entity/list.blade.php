        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="portlet light portlet-datatable " id="form_wizard_1">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="{{ route('entity.create') }}" data-target="#ajax" data-toggle="modal"> Agregar registro
                    ...
                    <div class="actions">
                        ...
                        <div class="btn-group btn-group-devided">
                            <div class="btn-group">
                                <a id="excel-expediente" class="btn green-haze btn-outline btn-circle" href="{{ route('entity.excel', Request::all()) }}">
                ...
                <div class="portlet-body">
                    ...
                    {!! Form::model(Request::all(), ['route' => 'entity.index', 'method' => 'GET']) !!}

                    <table class="table table-striped table-bordered table-hover order-column">

                        @include('system.entity.partials.search')
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a class="menu-ver" href="{{ route('entity.show', $row_id) }}" data-target="#ajax" data-toggle="modal">Ver</a></li>
                                            @can('update')
                                            <li><a class="menu-editar" href="{{ route('entity.edit', $row_id) }}" data-target="#ajax" data-toggle="modal">Editar</a></li>
                                            @endcan
                                        </ul>
                                    </div>
                                </td>
