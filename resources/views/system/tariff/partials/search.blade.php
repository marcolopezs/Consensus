<thead>
    ...
    <tr role="row" class="filter">
        ...
        <td>{!! Form::text('abrev', null, ['class' => 'form-control form-filter input-sm']) !!}</td>
        ...
        <td>
            ...
            <a href="{!! route('tariff.index') !!}" class="btn btn-sm btn-default filter-cancel"><i class="fa fa-times"></i></a>
        </td>
    </tr>
</thead>