            ...
            <div class="portlet light portlet-datatable " id="form_wizard_1">
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover order-column">
                        ...
                        @include('system.cliente-contacto.partials.search')

                        <tbody>
                        @foreach($rows as $item)
                            {{--*/
                            $row_id = $item->id;
                            $row_cliente = $item->contacto;
                            $row_dni = $item->dni;
                            $row_ruc = $item->ruc;
...
{!! Form::open(['route' => ['cliente.contactos.destroy', $prin->id, ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
