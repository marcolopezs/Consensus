    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="tarea-nueva" class="portlet-body">
                ...
                <div class="col-md-6">
                    <h4>Cliente: <strong>{{ $row->nombre }}</strong></h4>
                </div>
                ...
                {!! Form::model($prin, ['route' => ['cliente.documentos.update', $row->id, $prin->id], 'method' => 'PUT', 'id' => 'formCreate', 'class' => 'horizontal-form', 'autocomplete' => 'off', 'files' => 'true']) !!}
...
<script>
    ...
    var myDropzone = new Dropzone(".dropzone", {
        dictDefaultMessage: 'Da clic para seleccionar el documento',
