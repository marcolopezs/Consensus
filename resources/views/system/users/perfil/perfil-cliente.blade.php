                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <ul class="list-unstyled profile-nav">
                                    <li><img src="/imagenes/user-profile.png" class="img-responsive pic-bordered" alt="" /></li>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-8 profile-info">
                                        <h1 class="font-green sbold uppercase">Cliente: {{ $user->nombre_completo }}</h1>
                                        <p><a href="javascript:;"> {{ $user->profile->email }} </a></p>
                                    </div>
                                    <!--end col-md-8-->
                                    <div class="col-md-4">
                                        <div class="portlet sale-summary">
                                            <div class="portlet-body">
                                                <ul class="list-unstyled">
                                                    <li>
                                                        <span class="sale-info"> KARDEX <i class="fa fa-img-up"></i></span>
                                                        <span class="sale-num"> 23 </span>
                                                    </li>
                                                    <li>
                                                        <span class="sale-info"> EXPEDIENTES <i class="fa fa-img-down"></i></span>
