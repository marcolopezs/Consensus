<div class="modal-header">
    <h4 class="modal-title">Nuevo interviniente</h4>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="tarea-nueva" class="portlet-body">
                ...
                {!! Form::open(['route' => ['expedientes.intervinientes.store', $row->id], 'method' => 'POST', 'id' => 'formCreate', 'class' => 'horizontal-form', 'autocomplete' => 'off', 'files' => 'true']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('interviniente', [''=>''] + $intervinientes, null, ['class' => 'form-control select2', 'style' => 'width: 100%;']) !!}
                            </div>
                        </div>
...
<script>
    $("#formCreateClose").on("click", function (e) {
        ...
        var nombre = $("#nombre").val(), interviniente = $("#interviniente").val(), dni = $("#dni").val(),
                telefono = $("#telefono").val(), celular = $("#celular").val(), email = $("#email").val();

        formClose([nombre, interviniente, dni, telefono, celular, email]);
    });
</script>